...
K1 uses its own native build and development installation workflow. The provisioning,
aarch64 release packages and OTA instructions below target Radxa and must not be used on K1.
